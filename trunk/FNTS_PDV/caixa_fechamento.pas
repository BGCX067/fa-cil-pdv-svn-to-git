...
uses
  ...
  MemDS, DBAccess, IBC, ToolEdit, Menus, AdvMenus, pngimage, XPMan, AdvGlowButton;
...
type
  TfrmCaixa_Fechamento = class(TForm)
    ...
    btn2454f: TAdvGlowButton;
    btn2458888: TAdvGlowButton;
    btn245888: TAdvGlowButton;
    btn245800: TAdvGlowButton;
    btn247789: TAdvGlowButton;
    btn2477aas: TAdvGlowButton;
    btn2477aasqq: TAdvGlowButton;
    btfechar: TAdvGlowButton;
    btreducao: TAdvGlowButton;
    ...
    procedure btnfechasimplesClick(Sender: TObject);
    procedure AdvGlowButton1Click(Sender: TObject);
    procedure btn2454fClick(Sender: TObject);
    procedure btn2458888Click(Sender: TObject);
    procedure btn245888Click(Sender: TObject);
    procedure btn245800Click(Sender: TObject);
    procedure btn247789Click(Sender: TObject);
    procedure btn2477aasClick(Sender: TObject);
    procedure btn2477aasqqClick(Sender: TObject);
    procedure AdvGlowButton4Click(Sender: TObject);
    procedure btfecharClick(Sender: TObject);
    procedure btreducaoClick(Sender: TObject);
...
uses modulo, principal, funcoes, unECF, senha_supervisor, venda,
  msg_Operador, Math, menu_fiscal, UFuncoes, sangria;
...
procedure TfrmCaixa_Fechamento.btnfechasimplesClick(Sender: TObject);
begin
  ///funcao para so fechar
  begin
              // atualizando a tabela de config com a data do movimento e situacao fechado
...
procedure TfrmCaixa_Fechamento.AdvGlowButton1Click(Sender: TObject);
begin
  TabFechamento.Show;
end;

procedure TfrmCaixa_Fechamento.btn2454fClick(Sender: TObject);
begin
  TabSheet8.Show;
end;

procedure TfrmCaixa_Fechamento.btn2458888Click(Sender: TObject);
begin
  TabSheet6.Show;
end;

procedure TfrmCaixa_Fechamento.btn245888Click(Sender: TObject);
begin
  TabSheet5.Show;
end;

procedure TfrmCaixa_Fechamento.btn245800Click(Sender: TObject);
begin
  TabSheet4.Show;
end;

procedure TfrmCaixa_Fechamento.btn247789Click(Sender: TObject);
begin
  TabSheet3.Show;
end;

procedure TfrmCaixa_Fechamento.btn2477aasClick(Sender: TObject);
begin
  TabSheet2.Show;
end;

procedure TfrmCaixa_Fechamento.btn2477aasqqClick(Sender: TObject);
begin
  TabSheet1.Show;
end;
...
procedure TfrmCaixa_Fechamento.btfecharClick(Sender: TObject);
begin
 ///funcao para so fechar
  begin
              // atualizando a tabela de config com a data do movimento e situacao fechado
...
procedure TfrmCaixa_Fechamento.btreducaoClick(Sender: TObject);
var
  scodRZ: string;
  i: integer;
  pTexto: PAnsiChar;
...
procedure TfrmCaixa_Fechamento.btsangriaClick(Sender: TObject);
var i: integer;
begin
  if not bVenda then
  begin
