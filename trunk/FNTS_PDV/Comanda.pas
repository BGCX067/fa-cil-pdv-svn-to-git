...
uses
  ...
  Dialogs, StdCtrls, DB, MemDS, DBAccess, IBC, Mask, RzEdit;
...
begin
  if key = #13 then
  begin
    edit2 := Copy(EditComanda.Text, 3, 5);
    EditComanda.Text := edit2;
    FechaComanda;
...
begin
  ...
  begin
    ...
    begin
      ...
      frmModulo.mesa_comanda := Zerar(EditComanda.Text, 3);
