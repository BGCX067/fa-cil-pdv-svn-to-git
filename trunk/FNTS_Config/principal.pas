...
begin
  ...
  repeat
    ...
    if smsg <> 'OK' then
    begin
      if application.messagebox(pAnsichar('Erro ao tentar abrir a porta - ' + sECF_porta + #13 + 'Deseja tentar outra vez?'), 'ECF',
  ...
  begin
    ...
    repeat
      ...
      if smsg <> 'OK' then
      begin
        if application.messagebox(pAnsichar('ECF desligado ou não conectado!' + #13 + 'Mensagem: ' + smsg + #13 +
  ...
  begin
    ...
    REPEAT
      ...
      iF smsg = 'ERRO' then
      begin
        if application.messagebox(pAnsichar('Erro ao verificar totalizador do ECF!' + #13 + 'Mensagem: ' + smsg + #13 +
...
begin
  ...
  rewrite(F);
  writeln(F, 'Kodigo - IMPRESSAO - 1');
  writeln(F, 'Kodigo - IMPRESSAO - 2');
  writeln(F, 'Kodigo - IMPRESSAO - 3');
  writeln(F, 'Kodigo - IMPRESSAO - 4');
