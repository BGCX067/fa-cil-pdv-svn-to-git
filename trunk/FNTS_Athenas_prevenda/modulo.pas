...
begin
  ...
  assignfile(txt,'c:\Z5\server\ini\com.ini');
...
//      frmprincipal.lempresa1.Font.Color := clyellow;
    ...
    begin
      if trim(copy(entrada,9,1)) = '' then
        frmprincipal.caption := ' Fácil | Módulo de Atendimento ao Cliente   [ Servidor Local ]'
      else
        frmprincipal.caption := ' Fácil | Módulo de Atendimento ao Cliente   [ Servidor: '+trim(copy(entrada,9,50))+' ]';
    end;
